...
$H = \sum_\mu \Theta(-\xi^\mu\cdot\sigma)\frac{-\xi^\mu\cdot\sigma}{\sqrt{N}}$, where $\left{ \xi^\mu : \mu = 1,...,N_\xi \right}$ is a set of $N_\xi$ binary patterns $\xi^\mu \in \left{-1,+1\right}^N$.
