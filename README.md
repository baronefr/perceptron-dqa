...
$H = \sum_\mu \Theta(-\xi^\mu\cdot\sigma)\frac{-\xi^\mu\cdot\sigma}{\sqrt{N}}$, where $\lbrace \xi^\mu : \mu = 1,...,N_\xi \rbrace$ is a set of $N_\xi$ binary patterns $\xi^\mu \in \lbrace-1,+1\rbrace^N$.
