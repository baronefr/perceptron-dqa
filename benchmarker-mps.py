...
def function_to_run(P, dt, max_bond_dim, datafile, **ignore ):
    ...
    if save_curves:
        ...
        loss = np.array(loss)
        np.save('data/benchmark/numpy_9-12_loss/dt{}_bd{}.npy'.format(dt, max_bond_dim), loss)
...
parameter_combinations = [
    {'P' : 100, 'dt' : dt, 'max_bond_dim' : 10, 'datafile' : 'data/patterns_12-15.npy'} 
