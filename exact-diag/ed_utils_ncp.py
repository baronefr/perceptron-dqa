...
def H_QA(p, P, Hz, Hx):
    # getting the Hamiltonian of Quatnum Annealing process
    # at step p, given the objective and transverse field Hmiltonians
...
def init_state(n):
    # initial state is the ground state of transverse hamiltonian
